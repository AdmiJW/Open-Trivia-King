...
enum GameStates {
	...
	LOADING, SPLASH_SCREEN, ANSWERING, ANSWER_REVEAL, GAME_OVER, ERROR,
}
...
class GameState extends ChangeNotifier {
	...
	//*-------------------
	void progressState() {
		if (livesLeft != null && livesLeft! <= 0 && state == GameStates.ANSWER_REVEAL) {
	...
	void checkAnswerAndUpdateSessionData(AudioController audioController, String playerChoice) {
		...
		sessionData.correctsByCategory[ category ] = 
			sessionData.correctsByCategory.putIfAbsent(category, ()=> 0) + isCorrect;
	}
}