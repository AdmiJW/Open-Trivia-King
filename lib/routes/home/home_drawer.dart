...
class AppDrawer extends StatelessWidget {
	...
	// Drawer Header
	static const _headerTitleTextStyle = TextStyle(fontWeight: FontWeight.w100, fontSize: 40, color: Colors.white);
	static final drawerHeader = DrawerHeader(
		...
		child: Column(
			...
			children: const [ Text('MENU', style: _headerTitleTextStyle), ],
		),
	);
	...
	static const List<IconData> itemIcons = [Icons.person, Icons.settings, Icons.close];
