...
class GameQuestion extends StatelessWidget {
    ...
    if (gameState.livesLeft == null) {
      return const FadeInWithDelay(
        ...
        child: Text(
          ...
          style: TextStyle(
              fontWeight: FontWeight.w300, fontSize: 30, color: Colors.grey),
        ),
      );
    }
  ...
  Widget getQuestionText(GameState gameState) => FadeInWithDelay(
      ...
      child: Padding(
        ...
        child: Text(
          gameState.currTrivia?.question ??
              "Error Occurred. Please restart the application",
          textAlign: TextAlign.center,
  ...
  Widget getAnswerOptions(
      GameState gameState, AudioController audioController) {
